...
public class Recognize extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            Toast.makeText(this, mSelectedImageUri.toString(), Toast.LENGTH_LONG).show();
        ...
        iamOptionsBuilder.apiKey(getString(R.string.visualrecognitionApikey));
    ...
    private class ClassifyTask extends AsyncTask<Bitmap, Void, ClassifyTaskResult> {
        ...
        protected void onPostExecute(ClassifyTaskResult result) {
            ...
            if (result != null) {
                ...
                RecognitionResultBuilder resultBuilder = new RecognitionResultBuilder(Recognize.this);
                LinearLayout resultLayout = (LinearLayout) findViewById(R.id.recognitionResultLayout);
